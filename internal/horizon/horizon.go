...
func DefaultProfiles(deploymentID string, now time.Time) []contracts.ModelRoleProfile {
	return []contracts.ModelRoleProfile{
		...
		{Version: contracts.SchemaVersion, ID: task.NewID("mpr"), DeploymentID: deploymentID, Role: contracts.ModelRoleExecutor, Temperature: 0.1, MaxOutputTokens: 8192, MaxIterations: 4, MaxToolCalls: 4, CreatedAt: now, UpdatedAt: now},
