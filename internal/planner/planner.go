...
func (p *Planner) Create(ctx context.Context, input Input) (contracts.PlanVersion, error) {
	...
	}{Task: input.Task, Tools: input.AvailableTools})
	if err != nil {
		return contracts.PlanVersion{}, err
	}
