...
type Turn = { snapshot: Snapshot; report: { summary: string; tool_name: string; files: string[]; truncated: boolean; pending_write?: PendingWrite } }
